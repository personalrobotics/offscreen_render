...
namespace offscreen_render
{
    ...
    class CloudGenerator
    {
        public:
            ...
            void GenerateCloud(const FrameBuffer<float, 3>& buffer, const FrameBuffer<float, 3>& colorBuffer, PointCloud::Ptr cloud, const std::string& frame, const float& fx, const float& fy, const float& cx, const float& cy);
